...
class CartItem extends Component {
  ...
  onUpdateQuantity = (product, quantity) => {
    if(quantity > 0) {
      this.props.onUpdateProductInCart(quantity, product)
      this.props.onChangeMessageDelete(Message.MSG_UPDATE_TO_CART_SUCCESS)
  ...
  onDelete(product) {
    ...
    onDeleteProductInCart(product)
      this.props.onChangeMessageDelete(Message.MSG_DELETE_PRODUCT_IN_CART_SUCCESS)
    }
